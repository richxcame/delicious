...
export default {
  ...
  methods: {
    ...
    setArticle() {
      this.isLoading = true;
      this.$axios.post('/superadmin/articles', {
        name: this.name,
    ...
    updateArticle(item) {
      this.$axios.put(`/superadmin/articles/${item.id}`, item)
        .then(res => {
    ...
    deleteArticle({ id }) {
      this.$axios.delete(`/superadmin/articles/${id}`)
        .then(res => {
          this.$router.go()
        })
        .catch(err => {
  ...
  created() {
    this.$axios.get('/superadmin/articles')
      .then(res => {
